...
public class RESTController {
  ...
  public RESTController(FlowOrchestrator flowOrchestrator, LL84CSVFileLoader ll84CSVFileLoader, NYCHAFileLoader nychaFileLoader, PACEDAO PACEDAO, SOANAFileLoader soanaFileLoader, RentStabilizedFileLoader rentStabilizedFileLoader) {
    this.flowOrchestrator =
        requireNonNull(flowOrchestrator, "flowOrchestrator is required and missing.");
    this.ll84CSVFileLoader = requireNonNull(ll84CSVFileLoader,"ll84CSVFileLoader is required and missing.");
    this.nychaFileLoader = requireNonNull(nychaFileLoader,"nychaFileLoader is required and missing.");
    this.PACEDAO = requireNonNull(PACEDAO," is required and missing.");
    this.soanaFileLoader = requireNonNull(soanaFileLoader,"soanaFileLoader is required and missing.");;
    this.rentStabilizedFileLoader = requireNonNull(rentStabilizedFileLoader,"rentStabilizedFileLoader is required and missing.");;
  }
  ...
  public String loadRentStabilizedData(@RequestBody String rentStabilizedDataFile) throws Exception {
