    ...
    for (CSVRecord record : csvParser) {
      if (null != record) {
        ...
        try {
          ...
          ll84Data.setSelfReportedGrossFloorArea(
              parseIntoBigDecimal(record, "Self-Reported Gross Floor Area (ft²)"));
          ll84Data.setPrimaryPropertyTypeSelfSelected(
              parseIntoString(record, "Primary Property Type - Self Selected"));
          ll84Data.setListOfAllPropertyUseTypes(
          ...
          ll84Data.setWeatherNormalizedSiteEUI(
          ...
          ll84Data.setWeatherNormalizedSourceEUI(
              parseIntoBigDecimal(record, "Weather Normalized Source EUI (kBtu/ft²)"));
          ll84Data.setWeatherNormalizedSiteElectricity(
              parseIntoBigDecimal(
                  record, "Weather Normalized Site Electricity Intensity (kWh/ft²)"));
          ll84Data.setWeatherNormalizedNaturalGasIntensity(
              parseIntoBigDecimal(
          ...
          ll84Data.setDistrictHotWaterUse(
              parseIntoBigDecimal(record, "District Hot Water Use (kBtu)"));
          ll84Data.setDistrictChilledWaterUse(
          ...
          errorCounter++;
          LOG.error("Exception while processing BBL:{}", ll84Data.getBBL10Digits(), excp);
        }
